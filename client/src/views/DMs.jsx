...
const DMs = (props) => {
    ...
    const { user, setChat, newDM, currentChat } = props;
        ...
        <div className="dm-main">
            ...
            <div className="dm-allChats">
                ...
                {loaded && user.friends.map( (friend, i)  => {
                    return <div key={i} className="dm-convo dm-convotooltip" style={ friend._id === currentChat._id ? {backgroundColor : "rgb(57,60,67)", color : "white"} : {backgroundColor : "inherit"} }>
