        ...
        <div className="dm-user">
            ...
            <div className="dm-userIcons">
                <button className="dm-oneUserIcon DMtooltip" onClick={ toggleMute }>
                    <svg aria-hidden="false" width="20" height="20" viewBox="0 0 24 24" className="dm-bottomIcons" onClick={ toggleMute }>
                        ...
                        <path d="M21 4.27L19.73 3L3 19.73L4.27 21L8.46 16.82L9.69 15.58L11.35 13.92L14.99 10.28L21 4.27Z" fill="currentColor" className={muted ? 'dm-mute' : 'dm-muted'}></path>
                    </svg>
