...
const User = (props) => {
    ...
    return (
        <div className="dm-user">
            <svg className="dm-userAvatar" style={{ backgroundColor: `#${user.hexColor}` }} aria-hidden="false" width="28" height="20" viewBox="-3 0 33 20">
            ...
            <div className="dm-userCreds">
                <p className="dm-userName">{user.userName}</p>
                <p className="dm-userID">#{_id.substring(_id.length-4)}</p>
            </div>
            <div className="dm-userIcons">
                <button className="dm-oneUserIcon DMtooltip" onClick={ toggleMute }>
                    { muted ? <svg aria-hidden="false" width="20" height="20" viewBox="0 0 24 24" className="dm-bottomIcons" onClick={ toggleMute }>
                        <path d="M6.7 11H5C5 12.19 5.34 13.3 5.9 14.28L7.13 13.05C6.86 12.43 6.7 11.74 6.7 11Z" fill="currentColor"></path><path d="M9.01 11.085C9.015 11.1125 9.02 11.14 9.02 11.17L15 5.18V5C15 3.34 13.66 2 12 2C10.34 2 9 3.34 9 5V11C9 11.03 9.005 11.0575 9.01 11.085Z" fill="currentColor"></path>
