...
const SearchAll = (props) => {
    ...
    return (
        <div className="searchAll-wrapper"  ref={wrapperRef}>
            {/* <div className={"blurBackground"} style={{ opacity: '0.85', background: 'hsl(0, calc(var(--saturation-factor, 1) * 0%), 0%)', zIndex: '1000' }}></div> */}
                ...
                <div className="searchAll-main">
                    <div className="searchAll-darkGray">
                        ...
                        <div className="searchAll-options">
                            ...
                            .map((v, i) => {
                                return  (
                                    <div key={i} onClick={() => setSearchInput(v.userName)} className="searchAll-oneOption">
