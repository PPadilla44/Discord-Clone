...
const FriendsList =  (props) =>{
    ...
    const { user, users:allUsers, setChat } = props;
    ...
    return (
        <div>
            {allUsers.map((user,i) =>{
                return <div className="peopleListItemContainer inner" >
                    <div className="peopleListItemContents">
                        ...
                        <div className="peopleListItemActions">
                            <div className="peopleListItemButton">
                                <svg class="peopleListItemIcon"  onClick={() => createChat(user)} aria-hidden="false" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            <div className="peopleListItemButton">
                                <svg class="icon-35-fSh" aria-hidden="false" width="24" height="24" viewBox="0 0 24 24">
